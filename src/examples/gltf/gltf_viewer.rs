...
use crate::{app::{App, ShaderType}, assets_helper::{self, Model}, camera::{ArcballCamera, Camera}};
struct Renderer {
    queue: Queue,
...
impl GLTFViewerExample {
    ...
    fn get_light_matrix(time: f32) -> LightData {
        ...
        let light_proj_matrix = glm::ortho(-2., 2., -2., 2., -15., 15.);
